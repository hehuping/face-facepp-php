...
class Facepp
{
    ...
    public $api_key         = '9d5849438eec9796ff36b3185783897b';        // set your API KEY or set the key static in the property
    public $api_secret      = 'Qm3UU9FkaDcrsaN8e8NopzAv4OBbuQrI';        // set your API SECRET or set the secret static in the property
